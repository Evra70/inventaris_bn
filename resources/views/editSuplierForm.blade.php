...
@section('page-title', 'Form Edit Suplier')
    ...
    <div class="col">
      <div class="card shadow">
        <div class="card-header bg-transparent">
          <h3 class="mb-0 text-center">FORM EDIT SUPLIER</h3>
        </div>
        <div class="card-body">
          <form action="/proses/editSuplierProcess" method="post">
            {{csrf_field()}}
            <input name="suplier_id" type="hidden" value="{{$suplier->suplier_id}}">
            <div class="pl-lg-4">
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group {{ $errors->has('nama_suplier') ? ' has-error' : '' }}">
                    <label class="form-control-label" for="input-email">Nama Suplier</label>
                    <input type="text" id="input-fullname" value="{{$suplier->nama_suplier}}" class="form-control form-control-alternative" placeholder="Nama Suplier..."  name="nama_suplier">
                  </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group {{ $errors->has('alamat_suplier') ? ' has-error' : '' }}">
                    ...
                    <input type="text" id="input-username" value="{{$suplier->alamat_suplier}}" class="form-control form-control-alternative" placeholder="Alamat..." name="alamat_suplier">
                  </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group {{ $errors->has('telp_suplier') ? ' has-error' : '' }}">
                    ...
                    <input type="text" id="input-username" value="{{$suplier->telp_suplier}}" class="form-control form-control-alternative" placeholder="Telp..." name="telp_suplier">
                  </div>
