...
@section('page-title', 'Form Edit Barang Masuk')
    ...
    <div class="col">
      <div class="card shadow">
        <div class="card-header bg-transparent">
          <h3 class="mb-0 text-center">FORM EDIT BARANG MASUK</h3>
        </div>
        <div class="card-body">
          <form action="/proses/editBarangMasukProcess" method="post">
            {{csrf_field()}}
            <input type="hidden" name="barang_masuk_id" value="{{$barangMasuk->barang_masuk_id}}">
            <div class="pl-lg-4">
              <div class="row">
                <div class="col-lg-6">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group {{ $errors->has('jml_masuk') ? ' has-error' : '' }}">
                    ...
                    <input type="number" min="1" value="{{$barangMasuk->jml_masuk}}" autocomplete="off" id="input-username" class="form-control form-control-alternative" placeholder="Jumlah Masuk..." name="jml_masuk">
                  </div>
                ...
                <div class="col-lg-6">
                  <div class="form-group {{ $errors->has('suplier_id') ? ' has-error' : '' }}">
                    ...
                    <select class="form-control form-control-alternative" name="suplier_id">
                      <option value="{{$suplierSelected->suplier_id}}">{{$suplierSelected->nama_suplier}}</option>
